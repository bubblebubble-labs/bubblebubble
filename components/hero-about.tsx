    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6">
      <div className="pt-32 pb-10 md:pt-40">
        ...
        <div className="text-center">
          <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-amber-500 to-amber-200 pb-3">The folks behind the product</div>
