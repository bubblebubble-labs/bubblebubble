        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12">
          ...
          <div className="sm:col-span-12 lg:col-span-4 order-1 lg:order-none">
            <div className="h-full flex flex-col sm:flex-row lg:flex-col justify-between">
              ...
              <ul className="flex">
                <li>
                  <a className="flex justify-center items-center text-amber-500 hover:text-amber-400 transition duration-150 ease-in-out" href="#0" aria-label="Twitter">
                ...
                <li className="ml-2">
                  <a className="flex justify-center items-center text-amber-500 hover:text-amber-400 transition duration-150 ease-in-out" href="#0" aria-label="Dev.to">
                ...
                <li className="ml-2">
                  <a className="flex justify-center items-center text-amber-500 hover:text-amber-400 transition duration-150 ease-in-out" href="#0" aria-label="Github">
                    <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="text-sm space-y-2">
              <li>
                <a className="text-slate-400 hover:text-slate-200 transition duration-150 ease-in-out" href="#0">AI빵요미 소개</a>
              </li>
              <li>
                <a className="text-slate-400 hover:text-slate-200 transition duration-150 ease-in-out" href="#0">성심당 파트너십</a>
              </li>
              <li>
