            ...
            <div className="md:grow pb-12 md:pb-20">
              <div className="max-w-3xl">
                ...
                <article className="pb-12 mb-12 border-b [border-image:linear-gradient(to_right,transparent,theme(colors.slate.800),transparent)1]">
                  ...
                  <div className="mb-4">
                    <Link className="inline-flex text-sm font-medium text-amber-500 group" href="/customers"><span className="tracking-normal group-hover:-translate-x-0.5 transition-transform duration-150 ease-in-out mr-1">&lt;-</span> Go Back</Link>
                  </div>
