      ...
      <div className="max-w-sm mx-auto">
        ...
        <form>
          ...
          <div className="mt-6">
            <button className="btn text-sm text-white bg-amber-500 hover:bg-amber-600 w-full shadow-sm group">
              Sign Up <span className="tracking-normal text-amber-300 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">-&gt;</span>
            </button>
          </div>
        </form>
        ...
        <div className="text-center mt-4">
          <div className="text-sm text-slate-400">
            Already have an account? <Link className="font-medium text-amber-500 hover:text-amber-400 transition duration-150 ease-in-out" href="/signin">Sign in</Link>
          </div>
        </div>
